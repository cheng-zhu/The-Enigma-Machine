 ...
 *  @author P. N. Hilfinger and Cheng Zhu
 */
class TestUtils {
    ...
    protected static final Alphabet UPPER_SHORT =
            new Alphabet("ZABCDEFGHIJKLMNOPQRST");
    protected static final String UPPER_SHORT_STRING = "ZABCDEFGHIJKLMNOPQRST";

    protected static final Alphabet LOWER = new Alphabet("qwertyu");
    protected static final String LOWER_STRING = "qwertyu";

    protected static final Alphabet LOWERNUM =
            new Alphabet("asdfghjklzxcvbnmqwe12965");
    protected static final String LOWERNUM_STRING = "asdfghjklzxcvbnmqwe12965";

    protected static final Alphabet WEIRD = new Alphabet("@*89hA^&tBN");
    protected static final String WEIRD_STRING = "@*89hA^&tBN";

    protected static final Alphabet WEIRDER =
            new Alphabet("abcdefgABCDEFG!@#$%^&");
    protected static final String WEIRDER_STRING = "abcdefgABCDEFG!@#$%^&";
